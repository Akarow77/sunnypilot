...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"MacAcceleratorActive", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION | CLEAR_ON_IGNITION_ON, BOOL}},
    {"MacAcceleratorLoading", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION | CLEAR_ON_IGNITION_ON, BOOL}},
    ...
    {"MacAcceleratorDeadlineMs", {PERSISTENT, FLOAT, "55.0"}},
    {"MacAcceleratorExpectedModelSHA256", {PERSISTENT, STRING}},
