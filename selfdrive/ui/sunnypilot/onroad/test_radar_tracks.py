...
def test_format_radar_tracks_status_range_and_count():
  live_tracks = car.RadarData.new_message()
  live_tracks.trackSources = [{"startAddress": 0x500, "endAddress": 0x51F, "bus": 1}]
...
def test_format_radar_tracks_status_deduplicates_and_sorts_ranges():
  ...
  live_tracks.trackSources = [
    {"startAddress": 0x500, "endAddress": 0x51F, "bus": 2},
    {"startAddress": 0x210, "endAddress": 0x21F, "bus": 1},
    {"startAddress": 0x500, "endAddress": 0x51F, "bus": 0},
  ]
